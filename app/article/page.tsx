  ...
  return (
    <PageShell current="/article">
      <div className="max-w-3xl mx-auto px-8 py-16">
        ...
        {/* Metadata */}
        <div className="flex items-center gap-3 mb-8 text-xs text-[#4a4840]">
          <span className="px-2 py-1 rounded bg-white/[0.05] text-[#c8a96e]/70">Cartography</span>
          <span>March 18, 2026</span>
          <span>·</span>
          <span>9 min read</span>
        </div>

        <h1 className="text-5xl font-black leading-tight text-[#e8e4dc] mb-6 tracking-tight">
          The Hidden Shape of Information: What Topographic Thinking Reveals About Design
        </h1>

        <p className="text-xl text-[#7a7872] leading-relaxed mb-10 border-l-2 border-[#c8a96e]/30 pl-6">
        ...
        <div className="flex items-center gap-3 mb-12 pb-8 border-b border-white/[0.06]">
          <div className="w-9 h-9 rounded-full bg-[#c8a96e]/20 flex items-center justify-center text-xs text-[#c8a96e]">
            MK
          </div>
          <div>
            <p className="text-sm text-[#d4d0c8] font-medium">Mira Kessler</p>
            <p className="text-xs text-[#4a4840]">Design Systems · Cartography</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold text-[#e8e4dc] mb-4">The Elevation Problem</h2>

        <p className="text-[#6a6860] leading-relaxed mb-5">
        ...
        <p className="text-[#6a6860] leading-relaxed mb-10">
        ...
        <h2 className="text-2xl font-bold text-[#e8e4dc] mb-4">How Contour Lines Work</h2>
        ...
        <blockquote className="border-l-2 border-[#c8a96e]/40 pl-6 my-8">
          <p className="text-[#9a9890] italic leading-relaxed text-lg">
          ...
          <cite className="text-xs text-[#4a4840] mt-3 block not-italic">— Alfred Korzybski, paraphrased</cite>
        </blockquote>
        ...
        <h2 className="text-2xl font-bold text-[#e8e4dc] mb-4">Semantic Weight as Elevation</h2>

        <p className="text-[#6a6860] leading-relaxed mb-5">
          The key insight is that HTML already encodes a partial importance hierarchy. A
          <code className="text-[#c8a96e]/80 bg-white/[0.05] px-1.5 py-0.5 rounded mx-1 text-xs">&lt;h1&gt;</code>
          outranks
          <code className="text-[#c8a96e]/80 bg-white/[0.05] px-1.5 py-0.5 rounded mx-1 text-xs">&lt;h2&gt;</code>,
          which outranks
          <code className="text-[#c8a96e]/80 bg-white/[0.05] px-1.5 py-0.5 rounded mx-1 text-xs">&lt;p&gt;</code>.
        ...
        <h2 className="text-2xl font-bold text-[#e8e4dc] mb-4">What You See When You Look</h2>
        ...
        <h2 className="text-2xl font-bold text-[#e8e4dc] mb-4">Further Reading</h2>
        ...
        <ul className="space-y-2 mb-10">
          {[
            ...
            <li key={ref} className="text-sm text-[#5a5852] flex items-start gap-2">
              <span className="text-[#c8a96e]/40 mt-0.5">▸</span>
              <a href="#" className="hover:text-[#c8a96e]/70 transition-colors">{ref}</a>
            </li>
          ))}
        </ul>
        ...
        <div className="flex flex-wrap gap-2 pt-8 border-t border-white/[0.06]">
          {["Cartography", "Information Design", "DOM", "Marching Squares", "Data Visualization"].map((tag) => (
            <span key={tag} className="px-3 py-1 rounded-full border border-white/[0.07] text-xs text-[#5a5852]">
              {tag}
            </span>
          ))}
        </div>
