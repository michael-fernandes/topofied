  ...
  return (
    <PageShell current="/article">
      <div className="max-w-3xl mx-auto px-8 py-16">
        ...
        {/* Metadata */}
        <div className="flex items-center gap-3 mb-8 text-xs text-[#484848]">
          <span className="px-2 py-1 rounded bg-white/[0.05] text-[#a0a0a0]/70">Cartography</span>
          <span>March 18, 2026</span>
          <span>·</span>
          <span>9 min read</span>
        </div>

        <h1 className="text-5xl font-black leading-tight text-[#e8e8e8] mb-6 tracking-tight">
          The Hidden Shape of Information: What Topographic Thinking Reveals About Design
        </h1>

        <p className="text-xl text-[#787878] leading-relaxed mb-10 border-l-2 border-[#a0a0a0]/30 pl-6">
        ...
        <div className="flex items-center gap-3 mb-12 pb-8 border-b border-white/[0.06]">
          <div className="w-9 h-9 rounded-full bg-[#a0a0a0]/20 flex items-center justify-center text-xs text-[#a0a0a0]">
            MK
          </div>
          <div>
            <p className="text-sm text-[#d0d0d0] font-medium">Mira Kessler</p>
            <p className="text-xs text-[#484848]">Design Systems · Cartography</p>
          </div>
        </div>

        <h2 className="text-2xl font-bold text-[#e8e8e8] mb-4">The Elevation Problem</h2>

        <p className="text-[#686868] leading-relaxed mb-5">
        ...
        <p className="text-[#686868] leading-relaxed mb-10">
        ...
        <h2 className="text-2xl font-bold text-[#e8e8e8] mb-4">How Contour Lines Work</h2>
        ...
        <blockquote className="border-l-2 border-[#a0a0a0]/40 pl-6 my-8">
          ...
          <cite className="text-xs text-[#484848] mt-3 block not-italic">— Alfred Korzybski, paraphrased</cite>
        </blockquote>
        ...
        <h2 className="text-2xl font-bold text-[#e8e8e8] mb-4">Semantic Weight as Elevation</h2>

        <p className="text-[#686868] leading-relaxed mb-5">
          The key insight is that HTML already encodes a partial importance hierarchy. A
          <code className="text-[#a0a0a0]/80 bg-white/[0.05] px-1.5 py-0.5 rounded mx-1 text-xs">&lt;h1&gt;</code>
          outranks
          <code className="text-[#a0a0a0]/80 bg-white/[0.05] px-1.5 py-0.5 rounded mx-1 text-xs">&lt;h2&gt;</code>,
          which outranks
          <code className="text-[#a0a0a0]/80 bg-white/[0.05] px-1.5 py-0.5 rounded mx-1 text-xs">&lt;p&gt;</code>.
        ...
        <h2 className="text-2xl font-bold text-[#e8e8e8] mb-4">What You See When You Look</h2>
        ...
        <h2 className="text-2xl font-bold text-[#e8e8e8] mb-4">Further Reading</h2>
        ...
        <ul className="space-y-2 mb-10">
          {[
            ...
            <li key={ref} className="text-sm text-[#585858] flex items-start gap-2">
              <span className="text-[#a0a0a0]/40 mt-0.5">▸</span>
              <a href="#" className="hover:text-[#a0a0a0]/70 transition-colors">{ref}</a>
            </li>
          ))}
        </ul>
        ...
        <div className="flex flex-wrap gap-2 pt-8 border-t border-white/[0.06]">
          {["Cartography", "Information Design", "DOM", "Marching Squares", "Data Visualization"].map((tag) => (
            <span key={tag} className="px-3 py-1 rounded-full border border-white/[0.07] text-xs text-[#585858]">
              {tag}
            </span>
          ))}
        </div>
